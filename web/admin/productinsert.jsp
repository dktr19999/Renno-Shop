<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <title>More products | Admin</title>
            <meta charset="utf-8">
            ...
            <main class="app-content">
                <div class="app-title">
                    <ul class="app-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">More products</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="tile-body">
                                ...
                                <form class="row" action="productmanager?action=insertproduct" method="POST"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input class="form-control" placeholder="Blue,Gray,..." name="color"
                                            type="text">
                                    </div>
                                    <div class="form-group  col-md-3">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div id="boxchoice">
                                            <a href="javascript:" class="Choicefile"><i
                                                    class="fas fa-cloud-upload-alt"></i> Select image</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label class="control-label">List of products currently available</label>
