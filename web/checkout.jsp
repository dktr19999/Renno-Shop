                                ...
                                <div class="payment_method">
                                    <div class="panel-default">
                                        ...
                                        <label for="payment_defult" data-toggle="collapse" data-target="#collapsedefult"
                                               aria-controls="collapsedefult">Credit card payment <img src="assets/img/icon/papyel.png"
                                                                                 alt=""></label>
                                    </div>
                                    <div class="panel-default">
                                        <input id="payment_defult" value="vnpay" name="payment_method" type="radio"
                                               data-target="createp_account" />
                                        <label for="payment_defult" data-toggle="collapse" data-target="#collapsedefult"
                                               aria-controls="collapsedefult">Bank payment <img src="assets/img/icon/papyel.png"
                                                                                   alt=""></label>
                                    </div>
                                    <div class="panel-default">
