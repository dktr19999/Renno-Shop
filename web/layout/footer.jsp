            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="widgets_container contact_us">
                        ...
                        <div class="footer_contact">
                            ...
                            <p>Phone: <a href="tel:+(+84)888195313">0123456789</a> </p>
                            <p>Email: <a href="mailto:hotmail@gmail.com">hotmail@gmail.com</a></p>
                            <ul>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="widgets_container newsletter">
                        <h3>Receive new product information </h3>
                        <div class="newleter-content">
                            <p>Quality makes a brand !</p>
