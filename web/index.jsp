            ...
            <div class="container-fluid">
                <div class="row ">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product?action=search"><img src="assets/img/bg/banner9.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            ...
                                            <div class="quick_button">
                                                <a href="product?action=productdetail&product_id=${top10.product_id}" title="quick_view">View products</a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-3">
                                    <div class="single_product">
                                        <div class="product_thumb">
                                            ...
                                            <div class="quick_button">
                                                <a href="product?action=productdetail&product_id=${td.product_id}" title="quick_view">View products</a>
                                            </div>
                                        </div>
                                        <div class="product_content">
